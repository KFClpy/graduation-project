...
from service.dataSetService import get_dataset_info, delete_dataset_info, delete_column
...
dataDeleteParser.add_argument("column_name", required=True, help="列名不许为空")
...
class DeleteOneColumn(Resource, BaseView):
    ...
    def post(self):
        ...
        column_name = dataDeleteParser.parse_args()['column_name']
        try:
            data = {
                "username": user_name
            }
            delete_column(user_name, data_name, column_name)
