...
class AutoFJ(object):
    ...
    def join(self, left_table, right_table, id_column, on=None):
        ...
        LL_notNegative = nr.apply(LL_blocked)
        ...
        LL_distance, LR_distance = jf_space.compute_distance(left,
                                                             ...
                                                             LL_blocked,
                                                             LR_blocked)
        LL_notNegative_distance, LR_distance = jf_space.compute_distance(left,
                                                                         right,
                                                                         LL_notNegative,
                                                                         LR_blocked)
        threNew = dict()
        for key, value in LL_notNegative_distance.items():
            threNew[key] = value['title'].min()
